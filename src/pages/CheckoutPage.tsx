...
import type { DeliveryId, OrderForm, OrderData } from "../types/OrderContext";
...
const CheckoutPage: React.FC = () => {
	...
	return (
		<div className="checkoutPageContainer">
			...
			<p className="checkoutPageDeliveryTitle">Delivery Options</p>
			<div className="checkoutPageDeliveryOptionsContainer">
				{delivery.map((option) => (
					<div key={option.id} className="checkoutPageDeliveryOption">
						<input
							type="radio"
							id={option.id}
							name="delivery"
			...
			<p className="checkoutPageDeliveryTitle">Shipping Information</p>
			<div className="checkoutDoubleContainer">
				<Input
					label="First Name"
					name="firstName"
			...
			<p onClick={clickHandler} className="checkoutClearFormText">
